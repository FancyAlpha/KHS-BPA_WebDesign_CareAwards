...
<footer>
	<div class="container">
		...
		<div class="row about">
			<div class="footer-item">
				<p>
					John P Rangel<br> Carter Watson<br> Bryson Smith<br> Pranav Rayudu
				</p>
			</div>

			<div class="footer-item">
				<p>Chapter: 02-0478</p>
				<p>Keller High School<br>
				Keller, Texas</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		...
		<h4 class="policy-header">Non-Discrimination Policy</h4><p>It is the policy of Business Professionals of America that no person on the basis of race, color, religion, national origin or ancestry, age, sex, marital status, sexual orientation, or disability shall be discriminated against, excluded from participation in, denied the benefits of, or otherwise be subjected to, discrimination in any program or activity for which it is responsible
		</p>
