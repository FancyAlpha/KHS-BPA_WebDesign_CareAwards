<?php
//meta properties
$title = "Safety Awareness Award";
$desc = "Page describing main topics of the Safety Awareness Award";

//content
$heading = "Safety Awareness Award";
$sub_heading = "Making it safer";
$para = "Purpose
To encourage and recognize local chapters for their involvement and development of safety programs.
...
Activities may include but are not limited to volunteering, training and/or contributing to office safety, traffic safety, seat belt use, personal safety, drug awareness, anti-violence awareness, any National Organization of Youth Safety (NOYS) initiative or any other safety program.
